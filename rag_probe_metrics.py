...
def compute_metrics(df):
    ...
    df['confidence_normalized'] = df['probe_confidence'] / 100
...
# Load the CSV files
#col_math = pd.read_csv('./rag_results/Col_Math_RAG_with_probe.csv')
#biz_ethics = pd.read_csv('./rag_results/Biz_Ethics_RAG_with_probe.csv')
#prf_law = pd.read_csv('./rag_results/Prf_Law_RAG_with_probe.csv')
#com_secu = pd.read_csv('./rag_results/Com_Secu_RAG_with_probe.csv')
#anatomy = pd.read_csv('./rag_results/Anatomy_RAG_with_probe.csv')
#astronomy = pd.read_csv('./rag_results/Astronomy_RAG_with_probe.csv')
#marketing = pd.read_csv('./rag_results/Marketing_RAG_with_probe.csv')
#world_rel = pd.read_csv('./rag_results/World_Rel_RAG_with_probe.csv')
#gsm8k = pd.read_csv('./rag_results/GSM8K_RAG_with_probe.csv')
col_math = pd.read_csv('./rag_wiki_results/Col_Math_RAG_with_probe.csv')
biz_ethics = pd.read_csv('./rag_wiki_results/Biz_Ethics_RAG_with_probe.csv')
prf_law = pd.read_csv('./rag_wiki_results/Prf_Law_RAG_with_probe.csv')
com_secu = pd.read_csv('./rag_wiki_results/Com_Secu_RAG_with_probe.csv')
anatomy = pd.read_csv('./rag_wiki_results/Anatomy_RAG_with_probe.csv')
astronomy = pd.read_csv('./rag_wiki_results/Astronomy_RAG_with_probe.csv')
marketing = pd.read_csv('./rag_wiki_results/Marketing_RAG_with_probe.csv')
world_rel = pd.read_csv('./rag_wiki_results/World_Rel_RAG_with_probe.csv')
gsm8k = pd.read_csv('./rag_wiki_results/GSM8K_RAG_with_probe.csv')
...
#results.to_csv('./rag_results/RAG_with_probe_metrics.csv', index=False)
results.to_csv('./rag_wiki_results/RAG_with_probe_metrics.csv', index=False)
