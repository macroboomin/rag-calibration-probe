...
# Load the CSV files
col_math = pd.read_csv('./rag_results/Col_Math_RAG.csv')
biz_ethics = pd.read_csv('./rag_results/Biz_Ethics_RAG.csv')
prf_law = pd.read_csv('./rag_results/Prf_Law_RAG.csv')
com_secu = pd.read_csv('./rag_results/Com_Secu_RAG.csv')
anatomy = pd.read_csv('./rag_results/Anatomy_RAG.csv')
astronomy = pd.read_csv('./rag_results/Astronomy_RAG.csv')
marketing = pd.read_csv('./rag_results/Marketing_RAG.csv')
world_rel = pd.read_csv('./rag_results/World_Rel_RAG.csv')
gsm8k = pd.read_csv('./rag_results/GSM8K_RAG.csv')
#col_math = pd.read_csv('./rag_wiki_results/Col_Math_RAG.csv')
#biz_ethics = pd.read_csv('./rag_wiki_results/Biz_Ethics_RAG.csv')
#prf_law = pd.read_csv('./rag_wiki_results/Prf_Law_RAG.csv')
#com_secu = pd.read_csv('./rag_wiki_results/Com_Secu_RAG.csv')
#anatomy = pd.read_csv('./rag_wiki_results/Anatomy_RAG.csv')
#astronomy = pd.read_csv('./rag_wiki_results/Astronomy_RAG.csv')
#marketing = pd.read_csv('./rag_wiki_results/Marketing_RAG.csv')
#world_rel = pd.read_csv('./rag_wiki_results/World_Rel_RAG.csv')
#gsm8k = pd.read_csv('./rag_wiki_results/GSM8K_RAG.csv')
...
results.to_csv('./rag_results/RAG_metrics.csv', index=False)
#results.to_csv('./rag_wiki_results/RAG_metrics.csv', index=False)
